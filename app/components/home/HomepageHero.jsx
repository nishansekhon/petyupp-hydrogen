...
export default function HomepageHero() {
  ...
  return (
    <section className="homepage-hero bg-[var(--accent-cream)] pt-1 md:pt-4 lg:pt-6 pb-0">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col">
          ...
          <h1 className="font-heading font-medium text-gray-900 text-sm sm:text-base md:text-xl lg:text-2xl xl:text-3xl leading-[1.25] sm:leading-tight sm:tracking-tight mt-0 sm:mt-3 mb-3 sm:mb-4">
            <span className="block">Your dog deserves the best.</span>
            <span className="block italic text-xs sm:text-sm md:text-lg lg:text-xl xl:text-2xl" style={{color: '#5A7664'}}>
              Nature made it.<Leaf
                aria-hidden="true"
